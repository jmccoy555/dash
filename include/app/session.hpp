   ...
   public:
    ...
    struct System {
       ...
       private:
        ...
        // setting - see the constructor: force-writing a stale saved value
        // to amixer on every startup regardless of wherever the physical
        // volume control had actually left it is what caused the volume
        // to unexpectedly jump on every restart.
