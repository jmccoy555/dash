...
class AAHandler : public QObject, public openauto::service::IAndroidAutoInterface {
   ...
   public:
    ...
    // not always AA regardless - without this, starting local playback and
    // AA playback would both keep playing over each other. local_player is
    // null until LocalPlayerTab registers itself; AA is assumed active
    // until Local claims focus.
